...
set PDK_ROOT $::env(HOME)/.volare/sky130/versions/0fe599b2afb6708d281543108caf8310912f54af

# Librairie standard cells (High Density)
set LIB_PATH ${PDK_ROOT}/sky130A/libs.ref/sky130_fd_sc_hd/lib
set LEF_PATH ${PDK_ROOT}/sky130A/libs.ref/sky130_fd_sc_hd/lef
...
# Fichiers LEF
set TECH_LEF ${LEF_PATH}/sky130_fd_sc_hd.tlef
