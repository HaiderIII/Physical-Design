# rte_004: Congestion Catastrophe - FIXED VERSION
# Level: Expert
# PDK: Sky130HD

puts "=============================================="
puts " RTE_004 - Congestion Catastrophe (FIXED)"
puts "=============================================="
...
# Design files
set design_file "$puzzle_dir/resources/crossbar_switch.v"
...
initialize_floorplan -die_area "0 0 80 80" \
                     -core_area "5 5 75 75" \
                     -site unithd
...
# FIX: Proper layer adjustment strategy
# Lower layers (met1/met2) are congested with cell pins - reduce capacity
# Upper layers (met4/met5) have more tracks - keep capacity available
...
write_def $results_dir/crossbar_routed.def
