# plc_004: Padding Overflow - SOLUTION
# Level: Expert
# PDK: Sky130HD

puts "=============================================="
puts " PLC_004 - Padding Overflow (FIXED)"
puts "=============================================="
...
# FIX: Use reasonable padding values (1 site each side instead of 10)
# 10 sites was too aggressive for the available core area
