...
# Design files
set netlist_file "$script_dir/results/matrix_mult_synth.v"
...
initialize_floorplan -utilization 0.80 \
                     -aspect_ratio 1.0 \
                     -core_space 5 \
...
set_global_routing_layer_adjustment metal5 0.5
set_global_routing_layer_adjustment metal6 0.5
