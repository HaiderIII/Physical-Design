# plc_005: Routability Ruin - FIXED
# Level: Master
# PDK: Nangate45

puts "=============================================="
puts " PLC_005 - Routability Ruin (FIXED)"
puts "=============================================="
...
# Design files
set netlist_file "$parent_dir/results/matrix_mult_synth.v"
...
if {![file exists $netlist_file]} {
    puts "ERROR: Run the buggy version first to generate synthesis output"
    exit 1
}
...
# FIX: Enable routability-driven placement
...
# FIX: Use reasonable layer adjustment values
...
write_def $results_dir/matrix_mult.def
