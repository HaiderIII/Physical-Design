...
# BUG: Not running repair_design to fix DRC violations!
# The design has max_transition and max_capacitance violations
# that need to be fixed before signoff
...
puts ""
puts "NOTE: Check the DRC report above for violations."
puts "If there are slew/cap/fanout violations, run repair_design."

puts ""
puts "=============================================="
puts " Sign-off Complete"
puts "=============================================="
