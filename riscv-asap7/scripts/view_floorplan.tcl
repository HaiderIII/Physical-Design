# Script to view Phase 3 Floorplan in OpenROAD GUI
# Run with: openroad -gui scripts/view_floorplan.tcl
...
puts ""
puts "Save to: $project_dir/docs/images/02_floorplan/"
